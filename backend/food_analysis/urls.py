...
from .views import FoodLabelUploadView, FoodLabelHistoryView, FoodLabelDetailView, MyAnalysisCountView,AdminFoodLabelListView, DirectGeminiAnalysisView
...
urlpatterns = [
    ...
    DirectGeminiAnalysisView.as_view(),
    name="direct-gemini-analysis",
),
]